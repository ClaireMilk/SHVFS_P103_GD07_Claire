    ...
    public class Singleton<T> : MonoBehaviour where T : Singleton<T>
    {
        ...
        public static T instantce
        {
            ...
            get
            {
                ...
                //We Only want ONE instance ,ever with a singleton, never more than ONE.
                ...
                //if still null after checking the scene,instantiate a New GameObject
                if (instance == null)
                {
